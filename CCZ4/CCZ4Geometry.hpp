...
tensor<2, data_t>
compute_inverse_metric(const CCZ4::template vars_t<data_t> &vars);
...
template <class data_t>
chris_t<data_t>::chris_t(const CCZ4::vars_t<data_t> &vars,const CCZ4::vars_t<data_t> (&d1)[CH_SPACEDIM],const tensor<2, data_t>& h_UU)
{
   FOR3(i,j,k)
   {
...
template <class data_t>
chris_t<data_t>::chris_t(const CCZ4::vars_t<data_t> &vars,const CCZ4::vars_t<data_t> (&d1)[CH_SPACEDIM])
{
...
template <class data_t>
ricciZ_t<data_t>::ricciZ_t(const CCZ4::vars_t<data_t> &vars, const CCZ4::vars_t<data_t> (&d2)[CH_SPACEDIM][CH_SPACEDIM],
      const CCZ4::vars_t<data_t> (&d1)[CH_SPACEDIM],
      const chris_t<data_t>& chris,
      const tensor<2, data_t>& h_UU,
      const tensor<1, data_t>& Z_over_chi)
...
template <class data_t>
ricci_t<data_t>::ricci_t(const CCZ4::vars_t<data_t> &vars, const CCZ4::vars_t<data_t> (&d2)[CH_SPACEDIM][CH_SPACEDIM],
           const CCZ4::vars_t<data_t> (&d1)[CH_SPACEDIM],
           const chris_t<data_t>& chris,
