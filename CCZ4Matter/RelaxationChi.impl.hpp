...
void
RelaxationChi<matter_t>::compute(int ix, int iy, int iz)
{
    ...
    typename matter_t::vars_t<data_t> rhs = rhs_equation(vars, d1, d2, advec); //work out RHS including advection
...
RelaxationChi<matter_t>::rhs_equation(
