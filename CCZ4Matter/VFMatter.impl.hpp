...
#if !defined(VFMATTER_HPP_)
#error "This file should only be included through VFMatter.hpp"
#endif

#ifndef VFMATTER_IMPL_HPP_
#define VFMATTER_IMPL_HPP_

#define COVARIANTZ4

// Calculate the stress energy tensor elements
template <class data_t>
auto VFMatter::compute_emtensor(
...
template <class data_t>
auto VFMatter::compute_potential(const data_t phi_here) -> potential_t<data_t> {

  potential_t<data_t> out;

  //The potential value at phi
  out.V_of_phi = m_matter_params.vector_mass*phi_here*phi_here; // e.g. m^2 phi^2

  //The potential gradient at phi
  out.dVdphi = m_matter_params.vector_mass*2.0*phi_here;  //  e.g. 2 m^2 phi
...
template <class data_t>
auto VFMatter::compute_total_rhs(
