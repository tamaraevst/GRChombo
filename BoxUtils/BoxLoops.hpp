...
namespace BoxLoops
{
    ...
    template <typename... compute_ts, typename... simd_info>
    void loop(ComputePack<compute_ts...> compute_pack, const FArrayBox& in, FArrayBox& out, const Box & loop_box, simd_info... info);
    ...
    ///with input FArrayBox 'in' and output FArrayBox 'out'.
    template <typename... compute_ts, typename... simd_info>
    void loop(ComputePack<compute_ts...> compute_pack, const FArrayBox& in, FArrayBox& out, simd_info... info); //Uses out.box() as loop_box
    ...
    template <typename... compute_ts, typename... simd_info>
    void loop(ComputePack<compute_ts...> compute_pack, const LevelData<FArrayBox>& in, LevelData<FArrayBox>& out, bool fill_ghosts, simd_info... info);
