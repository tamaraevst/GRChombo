  ...
  public:
    ...
    struct Vars : public Constraints::Vars<data_t>, public MatterVars<data_t>
    {
        ...
        void enum_mapping(mapping_function_t mapping_function)
        {
            ...
            define_enum_mapping(mapping_function, c_chi, chi); // ADDED TEMPORARILY BY ROBIN
            define_symmetric_enum_mapping(mapping_function,
                                          GRInterval<c_h11, c_h33>(), h); // ADDED TEMPORARILY BY ROBIN
        }
    };
    ...
    /*!
       ...
       default.
    */
    Density(const matter_t a_matter, double dx,
                      double G_Newton = 1.0);
