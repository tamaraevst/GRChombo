...
template <typename t> struct _simd_remove_const
{
    typedef t type;
};
template <typename t> struct _simd_remove_const<const t>
{
    typedef t type;
};

template <typename t> struct _simd_remove_volatile
{
    typedef t type;
};
template <typename t> struct _simd_remove_volatile<volatile t>
{
    typedef t type;
};
...
{
    typedef typename _simd_remove_const<
        typename _simd_remove_volatile<t>::type>::type type;
};
