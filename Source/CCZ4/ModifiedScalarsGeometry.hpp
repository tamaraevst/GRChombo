...
{   
    ...
    This comes down to E and B being the same as in the GR case. Computation of this
    is shown in my note. Hence, we are indeed safe to use the same expressions as in the Weyl4 class.
    While it is possible to inherit private functions of Weyl4 class, I think
    it will make calling the class CCZ4GeometryModifiedGR along with ComputeModifiedScalars
    too cubersome in terms of arguments. Perhaps I am missing some better structure of the code.
    In practice, if we choose to have non-GR evolution equations and constraints, this
    class will have to be changed along with definitons of E and B. This is why, I would
