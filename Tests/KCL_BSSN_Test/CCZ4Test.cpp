...
int main()
{
    ...
    for (int zz = -3; zz < N_GRID+3; ++zz)
    {
        ...
        for (int yy = -3; yy < N_GRID+3; ++yy)
        {
            ...
            for (int xx = -3; xx < N_GRID+3; ++xx)
            {
                ...
                double chi;
                {
                    g[0][0] =  1.36778 + 2.39731*x + 4.53541*x*x + 19.9771*x*y*y*y + 6.13801*y*z + 5.65185*z*z + 9.35842*z*z*z*z;
                    g[0][1] = -0.07646 - 0.48786*x - 0.75098*x*x - 1.73683*x*y*y*y + 1.71676*y*z + 1.03662*z*z + 0.35630*z*z*z*z;
                    g[0][2] = -0.10083 + 0.12445*x - 1.26649*x*x - 1.95052*x*y*y*y + 0.73091*y*z - 1.49835*z*z - 2.39024*z*z*z*z;
                    g[1][1] =  0.84072 + 2.31163*x + 3.32275*x*x + 15.1662*x*y*y*y + 8.48730*y*z + 3.05098*z*z + 17.8448*z*z*z*z;
                    g[1][2] = -0.42495 - 0.33464*x - 0.47012*x*x - 7.38477*x*y*y*y + 0.41896*y*z - 1.36394*z*z + 5.25894*z*z*z*z;
                    g[2][2] =  0.60995 + 1.30428*x + 3.86237*x*x + 22.7614*x*y*y*y + 6.93818*y*z + 4.39250*z*z + 19.0244*z*z*z*z;
                    g[1][0] = g[0][1];
                    g[2][0] = g[0][2];
                    g[2][1] = g[1][2];
                ...
                in_fab(iv, c_phi)  = 0.34578 + 0.26898*x + 0.54348*x*x + 0.33487*x*y*y*y + 0.79469*y*z + 0.30515*z*z + 1.88385*z*z*z*z;
                in_fab(iv, c_Pi)  = 0.65668 + 0.20188*x + 0.34348*x*x + 0.31787*x*y*y*y + 0.88469*y*z + 0.10515*z*z + 1.88385*z*z*z*z;
    ...
    FORT_GETBSSNCRHSF(
                    ...
                    CHF_FRAn(out_fab_chf, c_h, SIX),
                    CHF_FRA1(out_fab_chf, c_K),
                    CHF_FRAn(out_fab_chf, c_A, SIX),
                    CHF_FRA1(out_fab_chf, c_Theta),
                    CHF_FRAn(out_fab_chf, c_Gamma, THREE),
                    CHF_FRA1(out_fab_chf, c_lapse),
                    CHF_FRAn(out_fab_chf, c_shift, THREE),
                    CHF_FRAn(out_fab_chf, c_B, THREE),
                    CHF_FRA1(out_fab_chf, c_phi),
                    CHF_FRA1(out_fab_chf, c_Pi),
                    CHF_CONST_FRA1(in_fab, c_chi2),
                    CHF_CONST_FRAn(in_fab, c_h, SIX),
                    CHF_CONST_FRA1(in_fab, c_K),
                    CHF_CONST_FRAn(in_fab, c_A, SIX),
                    CHF_CONST_FRA1(in_fab, c_Theta),
                    CHF_CONST_FRAn(in_fab, c_Gamma, THREE),
                    CHF_CONST_FRA1(in_fab, c_lapse),
                    CHF_CONST_FRAn(in_fab, c_shift, THREE),
                    CHF_CONST_FRAn(in_fab, c_B, THREE),
