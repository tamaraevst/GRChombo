...
int runGRChombo(int argc, char *argv[])
{
    ...
    st_amr.m_star_tracker.initial_setup(sim_params.do_star_track, sim_params.positionA,
        sim_params.star_points, sim_params.star_track_width_A, sim_params.star_track_direction_of_motion);
    ...
    AMRInterpolator<Lagrange<4>> interpolator(
                                       st_amr, sim_params.origin, sim_params.dx, 
