 ...
 */
 ...
 #ifndef PIEXTRACTION_HPP_
 #define PIEXTRACTION_HPP_
 
 #include "SphericalExtraction.hpp"
 //! This class allows extraction of the values of metric fields
 
 class PiExtraction : public SphericalExtraction
 {
   public:
     //! The constructor
     PiExtraction(SphericalExtraction::params_t &a_params, double a_dt,
     ...
     PiExtraction(SphericalExtraction::params_t &a_params, double a_dt,
         ...
         : PiExtraction(a_params, a_dt, a_time, (a_dt == a_time),
                            a_restart_time)
     {
     }
     ...
     void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
     {
             ...
             [](std::vector<double> scalar_reim_parts, double r, double, double)
         {
             ...
             // components
             return std::make_pair(r * scalar_reim_parts[0], r * scalar_reim_parts[1]);
         };
         ...
         {
             const auto &mode = m_modes[imode];
             std::string integrals_filename = "dtKGPsi" +
