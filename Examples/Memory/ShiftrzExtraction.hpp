...
#ifndef SHIFTRZEXTRACTION_HPP_
#define SHIFTRZEXTRACTION_HPP_

#include "SphericalExtraction.hpp"
//! This class allows extraction of the values of metric fields

class ShiftrzExtraction : public SphericalExtraction
{
  private:
  ...
  public:
    //! The constructor
    ShiftrzExtraction(SphericalExtraction::params_t &a_params, double a_dt,
                     double a_time, bool a_first_step,
                     double a_restart_time = 0.0)
        : SphericalExtraction(a_params, a_dt, a_time, a_first_step,
                              a_restart_time)
    {
        add_var(c_shiftrz, VariableType::diagnostic);
    }
    ...
    ShiftrzExtraction(SphericalExtraction::params_t &a_params, double a_dt,
        ...
        : ShiftrzExtraction(a_params, a_dt, a_time, (a_dt == a_time),
                           a_restart_time)
    {
    }
