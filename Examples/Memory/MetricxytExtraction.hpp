...
#ifndef METRICXYTEXTRACTION_HPP_
#define METRICXYTEXTRACTION_HPP_

#include "SphericalExtraction.hpp"
//! This class allows extraction of the values of metric fields

class MetricxytExtraction : public SphericalExtraction
{
  private:
  ...
  public:
    //! The constructor
    MetricxytExtraction(SphericalExtraction::params_t &a_params, double a_dt,
                     double a_time, bool a_first_step,
                     double a_restart_time = 0.0)
        : SphericalExtraction(a_params, a_dt, a_time, a_first_step,
                              a_restart_time)
    {
        add_var(c_gtxy, VariableType::diagnostic);
    }
    ...
    MetricxytExtraction(SphericalExtraction::params_t &a_params, double a_dt,
        ...
        : MetricxytExtraction(a_params, a_dt, a_time, (a_dt == a_time),
                           a_restart_time)
    {
    }
    ...
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
    {
        ...
        {
            const auto &mode = m_modes[imode];
            std::string integrals_filename = "Dtgxy" +
...
#endif /* METRICXYTEXTRACTION_HPP_ */