...
#ifndef LAPSEEXTRACTION_HPP_
#define LAPSEEXTRACTION_HPP_

#include "SphericalExtraction.hpp"
//! This class allows extraction of the values of metric fields

class LapseExtraction : public SphericalExtraction
{
  private:
  ...
  public:
    //! The constructor
    LapseExtraction(SphericalExtraction::params_t &a_params, double a_dt,
    ...
    LapseExtraction(SphericalExtraction::params_t &a_params, double a_dt,
        ...
        : LapseExtraction(a_params, a_dt, a_time, (a_dt == a_time),
                           a_restart_time)
    {
    }
    ...
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
    {
        ...
        {
            const auto &mode = m_modes[imode];
            std::string integrals_filename = "lapse" +
