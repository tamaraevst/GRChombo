...
#ifndef LAPSETEXTRACTION_HPP_
#define LAPSETEXTRACTION_HPP_

#include "SphericalExtraction.hpp"
//! This class allows extraction of the values of metric fields

class LapsetExtraction : public SphericalExtraction
{
  private:
  ...
  public:
    //! The constructor
    LapsetExtraction(SphericalExtraction::params_t &a_params, double a_dt,
                     double a_time, bool a_first_step,
                     double a_restart_time = 0.0)
        : SphericalExtraction(a_params, a_dt, a_time, a_first_step,
                              a_restart_time)
    {
        add_var(c_lapset, VariableType::diagnostic);
    }
    ...
    LapsetExtraction(SphericalExtraction::params_t &a_params, double a_dt,
        ...
        : LapsetExtraction(a_params, a_dt, a_time, (a_dt == a_time),
                           a_restart_time)
    {
    }
    ...
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
    {
        ...
        {
            const auto &mode = m_modes[imode];
            std::string integrals_filename = "DtLapse" +
